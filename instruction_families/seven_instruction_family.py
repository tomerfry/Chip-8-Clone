...
def handle_seven_family(top_byte, bottom_byte, raw):
    """
    ...
    value = bottom_byte
    return AddImmInstruction(v_register, value, raw)


class AddImmInstruction(Instruction):
    """
    ...
    def affect_chip_state(self, registers, mem, stack, screen):
        ...
        :return: None
        """
        registers.set_v_register(self.v_register, registers.v_registers[self.v_register] + self.value)
